...
```powershell
.\gradlew.bat :core_base:publishReleasePublicationToMavenLocal "-PPOM_GROUP_ID=com.github.wukuiqing49" "-PPOM_ARTIFACT_ID=AndroidCoreBase" "-PPOM_VERSION=v1.0.7" "-PGITHUB_REPOSITORY=wukuiqing49/AndroidCoreBase"
```

验证通过后，打开：

```text
https://jitpack.io/#wukuiqing49/AndroidCoreBase/v1.0.7
```
