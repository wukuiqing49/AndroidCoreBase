...
```bash
./gradlew :core_base:publishReleasePublicationToMavenLocal "-PPOM_GROUP_ID=com.github.local" "-PPOM_VERSION=v1.0.4"
```
...
.\gradlew.bat :core_base:publishReleasePublicationToMavenLocal "-PPOM_GROUP_ID=com.github.local" "-PPOM_VERSION=v1.0.4"
```
...
git status
git add .
git commit -m "release core_base 1.0.4"
...
```bash
./gradlew :core_base:publishReleasePublicationToGitHubPackagesRepository "-PPOM_GROUP_ID=com.github.wukuiqing49" "-PPOM_ARTIFACT_ID=AndroidCoreBase" "-PPOM_VERSION=v1.0.4"
```

Windows PowerShell：

```powershell
.\gradlew.bat :core_base:publishReleasePublicationToGitHubPackagesRepository "-PPOM_GROUP_ID=com.github.wukuiqing49" "-PPOM_ARTIFACT_ID=AndroidCoreBase" "-PPOM_VERSION=v1.0.4"
```
...
- 坐标是否写成 `com.github.wukuiqing49:AndroidCoreBase:v1.0.4`。
